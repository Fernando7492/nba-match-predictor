...
#### Para máquinas sem GPU NVIDIA (Apenas CPU):
O código possui detecção automática de hardware e executa normalmente em CPU. Caso deseje instalar uma versão mais leve do PyTorch sem os pacotes CUDA:
```bash
